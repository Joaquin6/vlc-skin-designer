...
RegistryKey
   ...
   * @exception  RegistryException  Any other registry API error.
	 ...
	 *
	 * @return The value enum_varerator.
	 *
     * @exception  RegistryException  Any valid registry API error.
	 */
	...
	/**
	 * Returns a new Enumeration that will enum_varerate the 
	 * names of the subkeys of this key,
	 *
	 * @return A new Enumeration to enum_varerate subkey names.
	 *
     * @exception  RegistryException  Any valid registry API error.
	 */
	 ...
	 *
	 * @return A new Enumeration to enum_varerate value names.
	 *
     * @exception  RegistryException  Any valid registry API error.
	 */
	...
	/**
	 * A RegistryKey enum_varerator class. This enum_varerator
	 * is used to enum_varerate the names of this key's subkeys.
	 *
	...
	/**
	 * A RegistryValue enum_varerator class. This enum_varerator
	 * is used to enum_varerate the names of this key's values.
	...
	export( PrintWriter out, boolean descend )
		throws NoSuchKeyException, RegistryException
		{
		Enumeration		enum_var;

		out.println( "[" + this.getFullName() + "]" );

		enum_var = this.valueElements();

		for ( int idx = 0 ; enum_var.hasMoreElements() ; ++idx )
			{
			String valueName = (String) enum_var.nextElement();
		...
		if ( descend )
			{
			enum_var = this.keyElements();

			for ( int idx = 0 ; enum_var.hasMoreElements() ; ++idx )
				{
				String keyName = (String) enum_var.nextElement();
