...
public class Main extends javax.swing.JFrame implements ActionListener, TreeSelectionListener, WindowListener{
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    // <editor-fold defaultstate="collapsed" desc="Test Skin">
      ...
      s.save();
      String[] command = { /*vlc_dir*/"X:\\tools\\VLC\\vlc-0.8.6d\\"+"vlc","-I","skins2","-skins2-last="+s.skinfile.getAbsolutePath(),"-skins2-config=\"\""};
      try {
        Runtime.getRuntime().exec(command);
      } catch (IOException ex) {
        ex.printStackTrace();
        JOptionPane.showMessageDialog(null,ex.toString(),"Error while launching VLC Media Player!",JOptionPane.ERROR_MESSAGE);
      }
    }
