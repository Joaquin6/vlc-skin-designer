...
public class Main extends javax.swing.JFrame implements ActionListener, TreeSelectionListener, WindowListener{
  ...
  JMenuItem m_file_new, m_file_open, m_file_save, m_file_vlt, m_file_quit;
  ...
  public Main() {
    ...
    if(System.getProperty("os.name").indexOf("Windows")!=-1) {
      try {      
        ...
        vlc_dir = installDir;
        vlc_skins_dir = installDir+File.separator+"skins";
      }
      catch (Exception e) {
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    // <editor-fold defaultstate="collapsed" desc="Export VLT">
      ...
      if(vlt_saver==null) {
        ...
        vlt_saver.setCurrentDirectory(new File(s.skinfolder));
